...
¡Échale un vistazo a la [guía de inicio](https://projects.raspberrypi.org/es-LA/projects/getting-started-guide-editor-html){:target="_blank"}!
...
<iframe src="https://editor.raspberrypi.org/es-LA/embed/viewer/anime-expressions-complete" width="600" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
</div>
</div>
...
--- print-only ---
![Proyecto terminado.](images/solution.PNG)
--- /print-only ---
