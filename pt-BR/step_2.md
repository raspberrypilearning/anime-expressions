...
<div>
<iframe src="https://editor.raspberrypi.org/pt-BR/embed/viewer/anime-expressions-step-2" width="500" height="400" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
</div>
</div>
...
Abra o [Projeto expressões iniciais do anime](https://editor.raspberrypi.org/pt-BR/projects/anime-expressions-starter){:target="_blank"}.
...
**Encontre** o comentário `<!-- O código do cabeçalho da página vai aqui -->`.
...
Clique no link [projeto inicial](https://editor.raspberrypi.org/pt-BR/projects/anime-expressions-starter){:target="_blank"} para abrir seu projeto. Use o mesmo navegador para ver suas alterações.
