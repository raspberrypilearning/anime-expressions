...
<div>
<iframe src="https://staging-editor.raspberrypi.org/en/embed/viewer/uk-UA-anime-expressions-step-2" width="500" height="400" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
</div>
</div>
...
Open the [Anime expressions starter project](https://staging-editor.raspberrypi.org/en/projects/uk-UA-anime-expressions-starter){:target="_blank"}.
